...
#endif
#ifdef _MSC_VER
/* Provide BSD-style unsigned types expected by GPL source */
...
#endif
#define Seek(fu, offset, whence) _lseek(fu, offset, whence)
#define DS '\\'
#define DSS "\\"
#define Newline "\r\n"
...
#define ValidFileHandle(fu) (fu != INVALID_HANDLE_VALUE)
#define CloseFile(fu) CloseHandle(fu)
#define Read(fu, buff, bytes) _read(fu, buff, bytes)
#define Write(fu, buff, bytes) _write(fu, buff, bytes)
#define RelinquishTimeslice Sleep(0)
#else
#define PRODUCT_KEY 2
